...
public class SearchStarView extends LinearLayout {
    ...
    public void setScore(int score) {
        ...
        switch (score) {
            case 1:
                mFirstStar.setImageResource(R.drawable.search_care_star_light);
                mSecondStar.setImageResource(R.drawable.search_care_star_normal);
                mThirdStar.setImageResource(R.drawable.search_care_star_normal);
                mFourthStar.setImageResource(R.drawable.search_care_star_normal);
                mFifthStar.setImageResource(R.drawable.search_care_star_normal);
                break;
            case 2:
                mFirstStar.setImageResource(R.drawable.search_care_star_light);
                mSecondStar.setImageResource(R.drawable.search_care_star_light);
                mThirdStar.setImageResource(R.drawable.search_care_star_normal);
                mFourthStar.setImageResource(R.drawable.search_care_star_normal);
                mFifthStar.setImageResource(R.drawable.search_care_star_normal);
                break;
            case 3:
                mFirstStar.setImageResource(R.drawable.search_care_star_light);
                mSecondStar.setImageResource(R.drawable.search_care_star_light);
                mThirdStar.setImageResource(R.drawable.search_care_star_light);
                mFourthStar.setImageResource(R.drawable.search_care_star_normal);
                mFifthStar.setImageResource(R.drawable.search_care_star_normal);
                break;
            case 4:
                ...
                mSecondStar.setImageResource(R.drawable.search_care_star_light);
                mThirdStar.setImageResource(R.drawable.search_care_star_light);
                mFourthStar.setImageResource(R.drawable.search_care_star_light);
                mFifthStar.setImageResource(R.drawable.search_care_star_normal);
                break;
            case 5:
                mFirstStar.setImageResource(R.drawable.search_care_star_light);
                ...
                mThirdStar.setImageResource(R.drawable.search_care_star_light);
                mFourthStar.setImageResource(R.drawable.search_care_star_light);
                mFifthStar.setImageResource(R.drawable.search_care_star_light);
                break;
        }
    }
}
