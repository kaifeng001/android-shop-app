...
public class MainBottomView extends LinearLayout implements View.OnClickListener {
    ...
    public void select(int position) {
        switch (position) {
            case 0:
                mHome.setImageResource(R.mipmap.main_home_select);
                mRecommend.setImageResource(R.mipmap.main_remend);
                mSearch.setImageResource(R.mipmap.main_search);
                mTalk.setImageResource(R.mipmap.main_talk);
                mCenter.setImageResource(R.mipmap.main_center);
                ...
                break;
            case 1:
                mHome.setImageResource(R.mipmap.main_home);
                mRecommend.setImageResource(R.mipmap.main_remend_select);
                mSearch.setImageResource(R.mipmap.main_search);
                mTalk.setImageResource(R.mipmap.main_talk);
                mCenter.setImageResource(R.mipmap.main_center);
            ...
            case 2:
                mHome.setImageResource(R.mipmap.main_home);
                mRecommend.setImageResource(R.mipmap.main_remend);
                mSearch.setImageResource(R.mipmap.main_search_select);
                mTalk.setImageResource(R.mipmap.main_talk);
                mCenter.setImageResource(R.mipmap.main_center);
            ...
            case 3:
                ...
                mRecommend.setImageResource(R.mipmap.main_remend);
                mSearch.setImageResource(R.mipmap.main_search);
                mTalk.setImageResource(R.mipmap.main_talk_select);
                mCenter.setImageResource(R.mipmap.main_center);
            ...
            case 4:
                ...
                mSearch.setImageResource(R.mipmap.main_search);
                mTalk.setImageResource(R.mipmap.main_talk);
                mCenter.setImageResource(R.mipmap.main_center_select);
